<template>
    <div>
        <section class="block9"><img src="img/goods/bg.png" alt="" class="block__bg block9__bg"/>
			<div class="container">
				<h1>Товары для <br>праздников</h1>
				<button class="button block9__button" @click="slide_down('.block10')">Выбрать товары</button>
			</div>
		</section>
        ...
        <section class="block12">
			<div class="container">
				<div class="block12__flex">
					<div class="title">Товары для <br>праздников <br>во Владивостоке</div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCategories(){
                $.ajax({
                    url: 'http://127.0.0.1:8000/api/v1/categories/?section=celebration',
                    type: 'GET',
                    success: (data) => {
            ...
            getProducts(id, page=1, load_next_page=false){
                ...
                $.ajax({
                    url: `http://127.0.0.1:8000/api/v1/products/?category=${id}&is_paginated=1&page=${page}`,
                    type: 'GET',
                    success: (data) => {
                        if (load_next_page) {
