<template>
    <div>
        <section class="block9"><img src="img/design/bg.png" alt="" class="block__bg block9__bg"/>
			<div class="container">
				<h1>Оформление <br>праздников</h1>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCategories(){
                $.ajax({
                    url: 'http://127.0.0.1:8000/api/v1/categories/?section=decoration',
                    type: 'GET',
                    success: (data) => {
