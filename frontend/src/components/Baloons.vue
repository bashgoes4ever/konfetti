<template>
    <div>
        <section class="block9"><img src="img/baloons/bg.png" alt="" class="block__bg block9__bg"/>
            <div class="container">
                <h1>Воздушные <br>шары</h1>
        ...
        <section class="block12">
            <div class="container">
                <div class="block12__flex">
                    <div class="title">Воздушные шары <br>с доставкой <br>во Владивостоке</div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getCategories(){
                $.ajax({
                    url: 'http://127.0.0.1:8000/api/v1/categories/?section=baloons',
                    type: 'GET',
                    success: (data) => {
